...
dic_more2zh={
    "VLM_AC":"AC adjustment",
    "CafeDaily":"A Day in the Cafe"
}
...
class UI(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self,robot_cls):
        ...
        lineEdit.setPlaceholderText("Please select another task")
        ...
        self.cb_task.setPlaceholderText("Please select more tasks")
