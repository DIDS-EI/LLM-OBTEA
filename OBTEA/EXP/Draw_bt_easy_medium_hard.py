...
# goal_states={"IsClean_Table1 & (On_Coffee_Table1 | On_Yogurt_Table1)" }
# goal_states={"IsClean_Table1 & (IsClean_Floor | IsClean_Chairs)" }
# goal_states={"~(On_VacuumCup_Bar | On_VacuumCup_Bar2) & ~Low_ACTemperature"}
# goal_states={"IsClean_Table1 & On_Coffee_Table1"}

# goal_states={"(On_Coffee_Table | On_Tea_Table) & ~Active_AC"}
goal_states={"(On_Coffee_Table | On_Tea_Table) & ~Active_AC"}
